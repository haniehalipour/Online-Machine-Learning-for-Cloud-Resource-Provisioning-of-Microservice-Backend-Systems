...
model = Sequential()
model.add(Bidirectional(LSTM(100, input_shape=(train_X.shape[1], train_X.shape[2]), return_sequences=True), input_shape=(train_X.shape[1], train_X.shape[2]),merge_mode='ave'))
model.add(Flatten())
model.add(Dense(1))
